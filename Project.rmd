...
We will now do a stupidity test for the Age variable by plotting the values in a histogram to see if it seems legit.
...
```{r}
  log_full <-  log(price+1) ~ (age + cross + desex + relinquished)^2
