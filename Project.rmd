...
### Cross
Cross is a catagorical variable. We need to make sure R treat it as a catagorical variable and to reset the string values of "NA" to the R value NA if there are any. This make sure that R does not include that data in analysis.
